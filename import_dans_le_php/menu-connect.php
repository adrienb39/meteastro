...
<body>
  ...
  <div class="div-logo">
    ...
    <!-- animation-info -->
    <div class="marquee">
        <div class="info">Ce site est actuellement en construction, nouvelle mise à jour majeur pour des fonctionnalitées et du contenus supplémentaires et correction de bugs ! Mise à jour du contenu en cours... !</div>
    </div>
</div>
  <!-- menu -->
  <nav id='menu'>
    ...
    <ul>
      <li><a class="a nav-link" href="/index-connect.php/#accueil">ACCUEIL</a></li>
      <!-- <li><a class="nav-link" href="/#identifier">S'IDENTIFIER</a></li> -->
      <li>
        <a class="a nav-link" href="/divers/astronomie-connect.php">ASTRONOMIE</a>
        <!-- <ul class="sous-menu">
      ...
      <li>
        <a class="a nav-link" href="/divers/meteorologie-connect.php">MÉTÉOROLOGIE</a>
        <!-- <ul class="sous-menu">
      ...
      <li><a class="a nav-link" href="/index-connect.php/#contacts">CONTACTS</a></li>
    </ul>
    <li style="background-color: red;">
        <a class="a nav-link"><?php echo $_SESSION['username']; ?></a>
        <ul class="sous-menu">
            <!-- <li><a class="a nav-link" href="">A PROPOS</a></li> -->
            <!-- <li><a class="a nav-link" href="">REGLAGES</a></li> -->
            <li><a class="a nav-link"><?php include "divers/contenu.php"; ?></a></li>
            <li><a class="a nav-link" href="">REGLAGES</a></li>
            <li><a class="a nav-link" href="/connexion/logout.php">DECONNEXION</a></li>
        </ul>
    </li>
  </nav>
  <!-- bouton-retour -->
