...
<body>
  ...
  <div class="div-logo">
    <a class="logo" href="">
      ...
      <span>METEASTRO - Bienvenue
        <?php echo $fetch_info['name']; ?>, vous êtes connecté sur ce site
      </span>
    </a>
    <!-- animation-info -->
    <div class="marquee">
      <div class="info">Ce site est actuellement en construction, nouvelle mise à jour majeur pour des fonctionnalitées
