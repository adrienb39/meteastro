    ...
    <nav>
      ...
      <ul class="nav">
        ...
        function html($data, $menu) {
          ...
          if ($count > 0) {
            echo '<li class=dropdown><a class="' . $menu['class'] . '" href=' . $menu['url'] . '>' . ucfirst($menu['menu_name']) . '</a><ul>';
            menu($data, $menu['id']);
            echo '</ul></li>';
          } else {
            echo '<li><a class="' . $menu['class'] . '" href=' . $menu['url'] . '>' . ucfirst($menu['menu_name']) . '</a></li>';
          }
        }
        ?>
      </ul>
