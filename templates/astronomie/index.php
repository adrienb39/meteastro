<?php
$posts = $posts ?? [];
$controllerAstroEvents = $astroEvents;
...
// Les événements sont déjà fournis par AstronomieController.
$astroEvents = $controllerAstroEvents;
?>
...
<main class="container">
    <div class="astro-grid glass-card">
        ...
        <div class="neon-card glass-card" data-aos="fade-up" data-aos-delay="300">
            <h3 style="font-family:'Orbitron'; font-size: 0.8rem; color: #fff;"><i class="fas fa-user-astronaut"></i> EN
                ORBITE</h3>
        ...
        <div class="astro-grid">
            <?php foreach ($posts as $post): ?>
                <article class="glass-card">
                    <a href="/astronomie/<?= $post['id'] ?>" class="card-anchor">
