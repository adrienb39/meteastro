<?php if ($page->getId() != 5 && $page->getId() != 8): ?>
    <div class="container">
        <div class="row flex">
            <div class="col py-3">
                <div class="mt-5 mb-5">
                    <h2 class="text-center">Insérer une image dans la page : <?= $page->getNom() ?></h2>
                <?php endif; ?>
                ...
                <div class="mt-5 mb-5 mx-auto">
                    <form id="editPageForm" method="post" enctype="multipart/form-data"
                        ...
                        <h3
                            ...
                            <i class="bi bi-image me-2"></i> Insertion d'une image dans la page
                        </h3>
                        ...
                        <div class="mb-4">
                            <label for="fichier_media" class="form-label fw-semibold text-muted">
                                <i class="bi bi-cloud-upload me-1"></i> Choisir le fichier image
                            </label>
                            <input type="file" name="fichier_media" id="fichier_media"
                                class="form-control <?= isset($error) ? 'border-danger' : '' ?>" accept="image/*"
                                required>
                        ...
                        <button type="submit" class="btn btn-primary w-100" name="action" value="save">
                            <i class="bi bi-check-circle me-1"></i> Télécharger l'image
                        </button>
