    ...
    <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
        ...
        <div class="d-flex flex-column flex-md-row">
            ...
            <a class="btn btn-success d-flex align-items-center rounded-3 shadow-sm mb-2 mb-md-0 me-md-3"
                href="/avva-admin/export-gravel/<?= $randonneeCible->getId() ?? '' ?>">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-striped table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php if (!empty($inscriptionsGravel)): ?>
                            <?php $i = 1; ?>
                            <?php foreach ($inscriptionsGravel as $inscription): ?>
                                <?php
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="7" class="text-center p-4 text-muted">
                                    <i class="fas fa-info-circle me-1"></i> Aucune inscription gravel trouvée pour cette randonnée.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
