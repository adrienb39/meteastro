<style>
   ...
   ========================================================== */
    ...
    .avva-login-wrapper {
        ...
        padding: 1.5rem;
        background: radial-gradient(circle at 50% 0%, rgba(40, 167, 69, 0.08) 0%, transparent 65%);
    }
    ...
    /* Boîte d'informations de paiement */
    .avva-info-box {
    ...
    .avva-info-row:not(:last-child) {
        border-bottom: 1px dashed var(--avva-border-color);
    }
    ...
    /* Zone d'affichage du QR Code avec effet de survol */
    .avva-qr-container {
    ...
    <div class="avva-card avva-card-wide">
        ...
        <div class="avva-card-body">
            ...
            <header class="avva-header avva-anim-1">
                ...
                <p class="avva-subtitle">Confirmation de paiement & Configuration 2FA</p>
            </header>
            ...
            <?php if (!empty($error)): ?>
                ...
                <a href="/cartoguide/achat-acces" class="avva-btn-primary avva-btn-secondary avva-anim-2">
                    <i class="bi bi-arrow-left avva-btn-icon"></i>
                    <span>Retourner à la page de paiement</span>
                </a>

            <?php else: ?>
                <div class="avva-step-badge avva-anim-2">
                    <i class="bi bi-check-circle-fill avva-icon-pulse me-1"></i>
                    <span>Paiement Validé - Étape finale</span>
                </div>

                <div class="text-center mb-3 avva-anim-2">
                    <h2 class="fw-bold fs-5 text-dark mb-1">
                        Merci <?= htmlspecialchars($membre ? $membre->getPrenom() : '') ?> !
                    </h2>
                    <p class="avva-description mb-0">
                        Votre abonnement est actif. Configurez votre application de sécurité pour sécuriser votre compte.
                    </p>
                </div>

                <div class="avva-info-box avva-anim-3">
                    <div class="avva-info-row">
                        <span class="avva-info-label">Statut du paiement</span>
                        <span class="avva-info-value text-success">
                            Payé <i class="bi bi-patch-check-fill ms-1"></i>
                        </span>
                    </div>
                    <div class="avva-info-row">
                        <span class="avva-info-label">Compte associé</span>
                        <span class="avva-info-value"><?= htmlspecialchars($membre ? $membre->getEmail() : '') ?></span>
                    </div>
                    <div class="avva-info-row">
                        <span class="avva-info-label">Code d'accès</span>
                        <span class="avva-info-value"><?= htmlspecialchars($membre ? $membre->getCodeAcces() : '') ?></span>
                    </div>
                </div>

                <div class="avva-qr-container avva-anim-4">
                    <?php if ($qrCodeUrl): ?>
                    ...
                    <?php else: ?>
                        <div class="avva-alert avva-alert-danger mb-0" role="alert">
                            ...
                            <span>Impossible de générer le QR code. Contactez l'assistance.</span>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <form action="" method="POST" novalidate class="avva-form">
                    ...
                    <button type="submit" class="avva-btn-primary avva-btn-success avva-anim-6">
                        ...
                        <i class="bi bi-arrow-right avva-btn-icon"></i>
                    </button>
        ...
        <footer class="avva-card-footer avva-anim-6">
            <a href="/cartoguide/connexion" class="avva-link">
                <i class="bi bi-arrow-left avva-arrow-left"></i> Retourner à la page de connexion
            </a>
        </footer>
