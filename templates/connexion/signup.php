...
/**
 * Vue d'inscription.
 * Variables injectées par LoginController::signup() via $this->render():
        ...
        <?php if ($isConnected): ?>
            <section class="box glass-card animate-in">
                ...
                <div class="action-group">
                    <a href="/" class="box-button secondary">RETOUR AU BORD</a>
                    <a href="logout.php" class="box-button logout-btn">DÉCONNEXION</a>
                </div>
            </section>

        <?php else: ?>
            <form action="" method="POST" class="box glass-card animate-in" autocomplete="off" novalidate>
                <header>
                ...
                <footer class="form-footer">
                    ...
                    <a href="/connexion/login" class="signup-link">CONNEXION AU COCKPIT</a>
                </footer>
...
<div id="termsModal" class="modal-overlay">
    <div class="modal-content glass-card animate-in">
        ...
        <div class="modal-body">
            ...
            <p>Vous pouvez utiliser notre site uniquement à des fins légales et d'une manière qui ne porte pas atteinte
                aux droits des autres utilisateurs.</p>
