...
use App\Entity\InscriptionRouteRandonnee; // Nom de l'entité refactorisée
use Doctrine\ORM\EntityManagerInterface; // Utilisation de l'interface pour le type hinting

class CreerInscriptionRouteRandonnee
{
     ...
     * * @return InscriptionRouteRandonnee
     */
    public function execute(
        ...
        $inscription = new InscriptionRouteRandonnee();
