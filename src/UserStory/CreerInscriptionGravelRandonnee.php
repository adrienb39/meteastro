...
use App\Entity\InscriptionGravelRandonnee; // Nom de l'entité refactorisée
use Doctrine\ORM\EntityManagerInterface; // Utilisation de l'interface pour le type hinting

class CreerInscriptionGravelRandonnee
{
     ...
     * * @return InscriptionGravelRandonnee
     */
    public function execute(
        ...
        $inscription = new InscriptionGravelRandonnee();
