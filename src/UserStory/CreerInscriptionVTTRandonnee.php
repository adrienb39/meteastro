...
use App\Entity\InscriptionVTTRandonnee; // Nom de l'entité refactorisée
use Doctrine\ORM\EntityManagerInterface; // Utilisation de l'interface pour le type hinting

class CreerInscriptionVTTRandonnee
{
     ...
     * * @return InscriptionVTTRandonnee
     */
    public function execute(
        ...
        $inscription = new InscriptionVTTRandonnee();
