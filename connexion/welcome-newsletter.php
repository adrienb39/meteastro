...
if ($userId && $_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $obj = new Db();
  // Met à jour la colonne avec 0 ou 1 (ne sera plus NULL)
  $sql = "UPDATE `users` SET `newsletter` = ? WHERE `id_users` = ?";
  $obj->query2($sql, [$newsletterChoice, $userId]);
...
<head>
  ...
  <title>MétéAstro - Abonnement Newsletter</title>
  ...
  <div class="container py-5 min-vh-100 d-flex justify-content-center align-items-center position-relative z-1">
    <div class="glass-card-cosmic p-4 p-md-5 text-center shadow-2xl">
      ...
      <p class="text-white-50 mb-4 leading-relaxed fs-6">
        Recevez nos alertes météo astronomiques, les prévisions de nuit claire et les actualités des événements célestes
        en avant-première.
      </p>
